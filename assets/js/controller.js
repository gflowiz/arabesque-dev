...
export default class Controller {
  ...
  import_nodes(){
    let nodesfile = document.getElementById("NodesImportFile").files[0];
    this.model.set_nodes_varnames(document.getElementById("NodeImportID").value,document.getElementById("NodeImportLat").value,document.getElementById("NodeImportLong").value)
  ...
  import_links(){
    let linksfile = document.getElementById("LinksImportFile").files[0];
    this.model.set_links_varnames(document.getElementById("LinksImportOrigineID").value,document.getElementById("LinksImportDestinationID").value,document.getElementById("LinksImportVolume").value)
